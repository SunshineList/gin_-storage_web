...
// auth
export function GetToken(username, password, captcha_id, captcha_val) {
  return new Promise((resolve, reject) => {
    normalRequest.post('/v1/user/login', {
      username: username,
      password: password,
...
export function GetCaptcha() {
  return new Promise(resolve => {
    normalRequest.get('/v1/user/getCaptcha').then((res) => {
      resolve(res)
    })
  })
}
